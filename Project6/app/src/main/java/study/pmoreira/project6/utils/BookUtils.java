...
public class BookUtils {
    ...
    public static final String LOG = BookUtils.class.getSimpleName();
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e(LOG, "Problem retrieving books JSON results.", e);
        } finally {
    ...
    private static List<Book> extractItemsFromJson(String json) {
        ...
        try {
            ...
            for (int i = 0; i < items.length(); i++) {
                ...
                books.add(new Book(author, title, language));
            }
